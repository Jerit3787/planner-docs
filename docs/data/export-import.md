...
(including Final Exams), study topics, subjects, programmes, semesters, and settings. Account
credentials themselves (your email/password) are never part of the export — only the academic data you
entered.
